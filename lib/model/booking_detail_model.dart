...
import 'package_data_model.dart';
...
class BookingDetailResponse {
  ...
  factory BookingDetailResponse.fromJson(Map<String, dynamic> json) {
    return BookingDetailResponse(
      ...
      bookingPackage: json['bookingpackage'] != null ? BookingPackage.fromJson(json['bookingpackage']) : null,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.bookingPackage != null) {
      data['bookingpackage'] = this.bookingPackage!.toJson();
    }
    return data;
  }
}
