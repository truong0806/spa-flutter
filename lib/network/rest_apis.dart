...
Future<Map<String, dynamic>> postPaymentMethod(Map<String, dynamic> payload) async {
  try {
    final response = await buildHttpResponse('get-payment-method', request: payload, method: HttpMethodType.POST);
