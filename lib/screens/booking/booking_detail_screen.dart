...
class BookingDetailScreen extends StatefulWidget {
  ...
  BookingDetailScreen({required this.bookingId, this.paymentSuccess = false});
...
//
  ...
  Widget _action({required BookingDetailResponse bookingResponse}) {
    if ((bookingResponse.service != null && bookingResponse.service!.isAdvancePayment && bookingResponse.bookingDetail!.bookingPackage == null) &&
        (bookingResponse.bookingDetail!.paymentStatus == null || bookingResponse.bookingDetail!.paymentStatus == 'failed' || (bookingResponse.bookingDetail!.paymentStatus == SERVICE_PAYMENT_STATUS_ADVANCE_PAID && bookingResponse.bookingDetail!.status == BookingStatusKeys.complete))) {
      return AppButton(
